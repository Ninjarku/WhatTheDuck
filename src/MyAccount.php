...
<head>
    ...
    <script>
        $(document).ready(function () {
            ...
            document.getElementById("birthday_input").value = "<?php echo $birthday; ?>";
                        ...
                        <form id="profile-form" method="post" enctype="multipart/form-data" class="d-flex w-100">
                            <div class="form-container">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="mobile_input" name="mobile_input" value="<?php echo $mobile; ?>"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="birthday_input" name="birthday_input"
                                        value="<?php echo $birthday; ?>" class="form-control">
                                </div>
