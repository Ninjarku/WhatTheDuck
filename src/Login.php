...
// Check if there is a message to display (e.g., session expired)
                ...
                <div class="login-form">
                    <form id="cust-login" method="post" accept-charset="UTF-8">
                        <div class="form-group" id="name-wrapper">
                            <input type="text" name="cust_username" id="cust_username" value="" class="form-control"
                                placeholder="Username" required="">
                        </div>
                        <div class="form-group" id="password-wrapper">
                            <input type="password" name="cust_pass" id="cust_pass" value="" class="form-control"
                                placeholder="Password" required="">
                        </div>
                        <input class="btn btn-primary" type="submit" name="op" id="submit" value="Sign In"
                            class="notranslate form-submit">
                    </form>
                </div>
